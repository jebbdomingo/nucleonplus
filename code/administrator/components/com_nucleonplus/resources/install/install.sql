...
# Generation Time: 2017-03-26 11:06:51 +0000
# ************************************************************
...
# Dump of table #__nucleonplus_accounts
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_accounts` (
...
CREATE TABLE `#__nucleonplus_cities` (
  ...
  PRIMARY KEY (`nucleonplus_city_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `#__nucleonplus_cities` WRITE;
/*!40000 ALTER TABLE `#__nucleonplus_cities` DISABLE KEYS */;

INSERT INTO `#__nucleonplus_cities` (`nucleonplus_city_id`, `name`, `province_id`)
VALUES
  (1,'Bangued',1),
  (2,'Boliney',1),
  (3,'Bucay',1),
...
/*!40000 ALTER TABLE `#__nucleonplus_cities` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table #__nucleonplus_configs
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_configs` (
...
LOCK TABLES `#__nucleonplus_configs` WRITE;
/*!40000 ALTER TABLE `#__nucleonplus_configs` DISABLE KEYS */;

INSERT INTO `#__nucleonplus_configs` (`nucleonplus_config_id`, `item`, `value`)
VALUES
  (1,'claim_request','disabled'),
  ...
  (3,'qbo_local','{ \"ACCOUNT_REVENUE\":\"151\",    \"ACCOUNT_ONLINE_PAYMENTS\"           :\"150\",\"ACCOUNT_BANK_REF\"                  :\"128\",     \"ACCOUNT_CHECKING_REF\"              :\"129\",     \"ACCOUNT_UNDEPOSITED_REF\"           :\"92\",     \"ACCOUNT_CHARGES\"                   :\"131\",     \"ACCOUNT_EXPENSE_DELIVERY\"          :\"139\",     \"ACCOUNT_REBATES\"                   :\"147\",     \"ACCOUNT_DIRECT_REFERRAL_BONUS\"     :\"146\",     \"ACCOUNT_PATRONAGE\"                 :\"135\",     \"ACCOUNT_PATRONAGE_FLUSHOUT\"        :\"138\",     \"ACCOUNT_REFERRAL_DIRECT\"           :\"133\",     \"ACCOUNT_REFERRAL_DIRECT_FLUSHOUT\"  :\"140\",     \"ACCOUNT_REFERRAL_INDIRECT\"         :\"134\",     \"ACCOUNT_REFERRAL_INDIRECT_FLUSHOUT\":\"137\",     \"ACCOUNT_INCOME_SHIPPING\"           :\"SHIPPING_ITEM_ID\",     \"STORE_ANGONO\"                      :\"1\",     \"UNILEVEL_COUNT\"                    :\"20\",     \"CONFIG_CONSUMER_KEY\"               : \"qyprdramIqMIseQbKmPYEzituYJmPe\",     \"CONFIG_CONSUMER_SECRET\"            :\"hUbviBNbSHTKWgibmZWminuIdEllxdJ2BkqO3kJY\",     \"CONFIG_SANDBOX\"                    :true,     \"CONFIG_OAUTH_URL\"                  :\"http://joomla.box/nucleonplus/administrator/components/com_qbsync/quickbooks/qbo/docs/partner_platform/example_app_ipp_v3/oauth.php\",     \"CONFIG_OAUTH_SUCCESS_URL\"          :\"http://joomla.box/nucleonplus/administrator/components/com_qbsync/quickbooks/qbo/docs/partner_platform/example_app_ipp_v3/success.php\",     \"CONFIG_DSN\"                        :\"mysqli://root:root@localhost/example_app_ipp_v3\",     \"CONFIG_ENCRYPTION_KEY\"             :\"bcde1234\",     \"CONFIG_USERNAME\"                   :\"DO_NOT_CHANGE_ME\",     \"CONFIG_TENANT\"                     :\"b7rmcac9tq\",     \"CONFIG_ONLINE_PURCHASE_ENABLED\"    :true }'),
  ...
  (6,'payout_run_date','2016-11-17'),
  (7,'payout_min_amount','500');

/*!40000 ALTER TABLE `#__nucleonplus_configs` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table #__nucleonplus_directreferrals
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_directreferrals` (
  `nucleonplus_directreferral_id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(50) NOT NULL COMMENT 'e.g. package or retail',
  `reward_id` int(11) NOT NULL COMMENT 'The Order''s Reward of other Member that pays the account_id',
  `account_id` int(11) NOT NULL COMMENT 'Account ID of the Direct Referrer',
...
CREATE TABLE `#__nucleonplus_employeeaccounts` (
...
# Dump of table #__nucleonplus_orderitems
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_orderitems` (
  `nucleonplus_orderitem_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`nucleonplus_orderitem_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

# Dump of table #__nucleonplus_orders
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_orders` (
...
# Dump of table #__nucleonplus_patronagebonuses
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_patronagebonuses` (
...
# Dump of table #__nucleonplus_payouts
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_payouts` (
...
LOCK TABLES `#__nucleonplus_provinces` WRITE;
/*!40000 ALTER TABLE `#__nucleonplus_provinces` DISABLE KEYS */;

INSERT INTO `#__nucleonplus_provinces` (`nucleonplus_province_id`, `name`)
VALUES
  (1,'Abra'),
  (2,'Agusan del Norte'),
  (3,'Agusan del Sur'),
...
/*!40000 ALTER TABLE `#__nucleonplus_provinces` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table #__nucleonplus_rebates
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_rebates` (
  `nucleonplus_rebate_id` int(11) NOT NULL AUTO_INCREMENT,
  `reward_id` int(11) NOT NULL COMMENT 'The Order''s Reward',
  `account_id` int(11) NOT NULL,
  `payout_id` int(11) NOT NULL,
  `points` decimal(10,2) NOT NULL,
  `void` smallint(1) NOT NULL DEFAULT '0',
...
# Dump of table #__nucleonplus_referralbonuses
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_referralbonuses` (
...
# Dump of table #__nucleonplus_rewards
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_rewards` (
  ...
  `payout_id` int(11) NOT NULL,
  `type` varchar(50) NOT NULL COMMENT 'Reward type (i.e. package or retail) see #__nucleonplus_rewardpacakges',
  `slots` int(11) NOT NULL COMMENT 'Number of Slots',
  `prpv` decimal(10,2) NOT NULL COMMENT 'Product Rebate Point Value',
  `drpv` decimal(10,2) NOT NULL COMMENT 'Direct Referral Point Value',
  `irpv` decimal(10,2) NOT NULL COMMENT 'Indirect Referral Point Value',
  `rebates` decimal(10,2) NOT NULL COMMENT 'Customer''s rebates',
...
# Dump of table #__nucleonplus_slots
# ------------------------------------------------------------

CREATE TABLE `#__nucleonplus_slots` (
