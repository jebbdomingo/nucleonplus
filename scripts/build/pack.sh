...
# Clean up
rm -rf installer
rm -f com_nucleonplus_installer.zip
rm -f com_nucleonplus.zip
...
unzip -q com_nucleonplus.zip -d $payload_dir/nucleonplus
unzip -q joomlatools-framework.zip -d $payload_dir/framework

# zip it all up
zip -q -r com_nucleonplus_installer.zip installer
